...
dataPATH = 'sftp://134.74.76.221/home/ovelarde/snap/snapd-desktop-integration/253/Documents/MNIST_Symmetries/'
resultsPATH = '/home/ovelarde/snap/snapd-desktop-integration/253/Documents/MNIST_Symmetries/results/'
...
results = torch.zeros(num_thresholds,6)

for idx_thr, thr in enumerate(thresholds):
	print('Running Threshold: ', thr)
	...
	results[idx_thr,0]= thr.item()
	results[idx_thr,1]= num_colors_l1
	results[idx_thr,2]= num_colors_l2
	results[idx_thr,3]= num_colors_l3
	results[idx_thr,4]= num_params/num_params_original
	results[idx_thr,5]= acc.item()

	torch.save(net_coll.state_dict(), resultsPATH + 'collapse/model_collapse_12.pt')
	
torch.save(results, resultsPATH + 'collapse/post_training.pth')
